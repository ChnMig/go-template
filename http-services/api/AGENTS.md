...
- `NewRouter` requires the HTTP config snapshot and route registrar; construction errors must reach bootstrap.
...
- Error response logs include the complete response envelope and request fields collected by `log.WithRequest`.
